...
public class DelayStatServiceImpl implements DelayStatService {
    ...
    public List<TopDelayStat> listTopDelayStat(String searchKey) {
        return delayStatDao.listTopDelayStatsByName(searchKey);
    }
    
    public List<TopDelayStat> listTopDelayStat(String searchKey, long userId) {
        return delayStatDao.listTopDelayStatsByName(searchKey, userId);
    }
