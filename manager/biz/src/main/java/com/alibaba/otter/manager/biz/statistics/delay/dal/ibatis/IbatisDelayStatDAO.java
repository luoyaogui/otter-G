...
public class IbatisDelayStatDAO extends SqlMapClientDaoSupport implements DelayStatDAO {
    ...
    public List<TopDelayStat> listTopDelayStatsByName(String searchKey) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("searchKey", searchKey);
        return (List<TopDelayStat>) getSqlMapClientTemplate().queryForList("listTopByName", param);
    }

    public List<TopDelayStat> listTopDelayStatsByName(String searchKey, long userId) {
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("searchKey", searchKey);
        param.put("userId", userId);
        return (List<TopDelayStat>) getSqlMapClientTemplate().queryForList("listTopByName0", param);
    }
}
